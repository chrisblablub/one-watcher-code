...
public:
    enum DriverFeature { Transactions, QuerySize, BLOB, Unicode, PreparedQueries,
                         ...
                         EventNotifications, FinishQuery, MultipleResultSets, CancelQuery, SslSupport };
...
protected:
    QString sslKeyFilename;
    QString sslCertificateFilename;
    QString sslCertificateCaFilename;
    QString sslCertificateCaPath;
    QString sslCipher;
