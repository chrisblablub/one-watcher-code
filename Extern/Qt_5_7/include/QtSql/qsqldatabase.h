...
public:
    ...
    void setSslKeyFilename(const QString& fname);
    void setSslCertificateFilename(const QString& fname);
    void setSslCertificateCaFilename(const QString& fname);
    void setSslCertificateCaPath(const QString& path);
    void setSslCipher(const QString& cipher);
    void setPort(int p);
	...
	QString sslKeyFilename() const;
	QString sslCertificateFilename() const;
	QString sslCertificateCaFilename() const;
	QString sslCertificateCaPath() const;
	QString sslCipher() const;
    int port() const;
